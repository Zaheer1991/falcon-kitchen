    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
            ...
            <div class="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                ...
                <ul class="text-gray-400 transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-300">Home</a></li>
                    <li class="mb-6"><a href="javascript:;" class="text-gray-400 hover:text-gray-300">About</a></li>
